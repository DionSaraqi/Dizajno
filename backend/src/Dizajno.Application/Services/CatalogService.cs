...
public sealed class CatalogService : ICatalogService
{
    ...
    public CatalogService(DizajnoDbContext db) => _db = db;

    public async Task<ActionResult<IReadOnlyList<FurnitureItemDto>>> GetProductsAsync(
        string? family,
        string? category,
    ...
    public async Task<ActionResult<FurnitureItemDto>> GetProductAsync(
        string slug,
        CancellationToken cancellationToken)
    {
        ...
        return new OkObjectResult(ToDto(row, textureSlots));
    }
    ...
    public async Task<ActionResult<IReadOnlyList<SupplierDto>>> GetSuppliersAsync(
        CancellationToken cancellationToken)
    {
